...
> Brainstorming che ha portato alla scelta dell'Approccio B (ESP-NOW + Bridge AP). Le decisioni sono state consolidate nella spec del 2026-04-26 e nel documento operativo `docs/grounding/07-ARCHITETTURA-SWARM.md`. Conservato per la motivazione delle alternative valutate (utile per la tesi).
